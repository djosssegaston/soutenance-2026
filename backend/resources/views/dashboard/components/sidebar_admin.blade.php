<aside class="dashboard-sidebar sidebar" id="dashboardSidebar" aria-label="Navigation administrateur">
  <div class="dashboard-sidebar__top">
    ...
    <div class="logo-section">
      <a class="dashboard-brand" href="<?php echo htmlspecialchars(route('dashboard.admin'), ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <nav class="dashboard-nav nav flex-column">
      <a class="dashboard-nav__link nav-link sidebar-link" data-nav="dashboard" href="<?php echo htmlspecialchars(route('dashboard.admin'), ENT_QUOTES, 'UTF-8'); ?>"><i class="bi bi-grid"></i><span>Dashboard</span></a>
