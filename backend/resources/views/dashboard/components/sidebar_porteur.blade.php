<aside class="dashboard-sidebar sidebar" id="dashboardSidebar" aria-label="Navigation porteur de projet">
  <div class="dashboard-sidebar__top">
    ...
    <div class="logo-section">
      <a class="dashboard-brand" href="<?php echo htmlspecialchars(route('dashboard.porteur'), ENT_QUOTES, 'UTF-8'); ?>">
    ...
    <nav class="dashboard-nav nav flex-column">
      <a class="dashboard-nav__link nav-link sidebar-link" data-nav="dashboard" href="<?php echo htmlspecialchars(route('dashboard.porteur'), ENT_QUOTES, 'UTF-8'); ?>"><i class="bi bi-grid"></i><span>Dashboard</span></a>
      ...
      <a class="dashboard-nav__link nav-link sidebar-link" data-nav="repayments" href="<?php echo htmlspecialchars(dashboard_url('remboursement.php'), ENT_QUOTES, 'UTF-8'); ?>"><i class="bi bi-credit-card-2-front"></i><span>Remboursements</span></a>
      <a class="dashboard-nav__link nav-link sidebar-link" data-nav="repayment-schedule" href="<?php echo htmlspecialchars(dashboard_url('echeancier_remboursement.php'), ENT_QUOTES, 'UTF-8'); ?>"><i class="bi bi-calendar3"></i><span>&Eacute;ch&eacute;ancier</span></a>
