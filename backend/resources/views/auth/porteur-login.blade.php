...
@push('meta')
<meta name="description" content="Alogoto – Connexion Porteur">
<meta name="keywords" content="microfinance, connexion, porteur, Alogoto">
@endpush
...
<div class="login-card">
    ...
    <div class="login-title">
        <h2>Connexion Porteur de Projet</h2>
        <p>Accédez à votre tableau de bord pour suivre vos projets</p>
    </div>
        ...
        <div class="login-tab-content active" id="tab5">
            <div class="form-group">
                ...
                <div class="input-group-custom @error('identifier') is-invalid @enderror">
                    ...
                    <input type="email" id="login-email" name="identifier" class="form-control-custom" placeholder="exemple@email.com" value="{{ old('identifier', $prefill_email ?? '') }}" autocomplete="email" required autofocus>
                </div>
                @error('identifier')
    ...
    <div class="social-login-section">
        ...
        <div class="social-login-buttons">
            <a href="{{ route('social.redirect', ['provider' => 'twitter-oauth-2', 'role' => 'porteur']) }}" class="social-btn" aria-label="Twitter"><i class="fa fa-twitter"></i></a>
            <a href="{{ route('social.redirect', ['provider' => 'google', 'role' => 'porteur']) }}" class="social-btn" aria-label="Google"><i class="fa fa-google"></i></a>
            <a href="{{ route('social.redirect', ['provider' => 'facebook', 'role' => 'porteur']) }}" class="social-btn" aria-label="Facebook"><i class="fa fa-facebook"></i></a>
        </div>
    </div>
