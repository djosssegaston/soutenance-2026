...
class FundingWebController extends Controller
{
    ...
    public function index(Request $request): JsonResponse
    {
        ...
        $data = $fundings->map(function (Funding $f) use ($statusLabels) {
            ...
            return [
                ...
                'project_titre' => $f->project->titre ?? 'N/A',
                'project_statut' => $f->project->statut ?? 'N/A',
                'institution_id' => $f->institution_id,
                'institution_nom' => $f->institution->nom ?? 'N/A',
                ...
                'duree' => $f->duree,
                'date_financement' => $f->date_financement?->format('d M Y') ?? 'N/A',
                'statut' => $statut['label'],
    ...
    public function documents(Request $request): JsonResponse
    {
        ...
        $data = $documents->map(function ($doc) {
            return [
                'id' => $doc->id,
                'project_titre' => $doc->project->titre ?? 'N/A',
