    ...
    <script src="../../asset/js/plugins/flot/dashboard.sampledata.js"></script>
     <!-- { INTERNAL SUMMERNOTE Modifieror JS } -->
    <script src="../../asset/js/plugins/summernote/summernote1.js"></script>
    <script src="../../asset/js/summernote.js"></script>
    <script src="../../asset/js/plugins/dropzone/dropzone.js"></script>
     <!-- DATEPICKER JS -->
    <script src="../../asset/js/plugins/date-picker/date-picker.js"></script>
    <script src="../../asset/js/plugins/date-picker/jquery-ui.js"></script>
     <!-- { page js } -->
    <script src="../../asset/js/ecommerce-product-add.js"></script>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow mobile-profile-dropdown">
                    <div class="drop-heading">
                        <div class="text-center">
                            <h5 class="text-dark mb-0 fs-14 fw-semibold" id="mobile-profile-name">Porteur de Projet</h5>
