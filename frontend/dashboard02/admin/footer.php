                ...
                if (list) {
                    if (!conversations.length) {
                        ...
                        list.innerHTML = conversations.slice(0, 5).map(function(conv) {
                            ...
                            return '<a class="dropdown-item d-flex" href="messagesadmin.php?id=' + conv.id + '">' +
        ...
        <div class="mobile-bottom-nav__container">
            ...
            <div class="dropdown mobile-bottom-nav__slot">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow mobile-notifications-dropdown">
                    ...
                    <a href="notificationsadmin.php" class="dropdown-item text-center p-3 text-muted">Voir toutes les notifications</a>
                </div>
            </div>
            ...
            <div class="dropdown mobile-bottom-nav__slot">
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow mobile-messages-dropdown">
                    ...
                    <div class="dropdown-divider m-0"></div>
                    <a href="messagesadmin.php" class="dropdown-item text-center p-3 text-muted">Voir tous les messages</a>
                </div>
            </div>
                ...
                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow mobile-profile-dropdown">
                    <div class="drop-heading">
                        <div class="text-center">
                            <h5 class="text-dark mb-0 fs-14 fw-semibold" id="mobile-profile-name">Administrateur</h5>
    ...
    <?php
    // Vérification rapide : Reverb tourne-t-il sur le port 8080 ?
