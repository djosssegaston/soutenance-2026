                                            ...
                                            <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                                <div class="drop-heading">
                                                    <div class="text-center">
                                                        <h5 class="text-dark mb-0 fs-14 fw-semibold" id="header-user-name"><?php echo htmlspecialchars(auth()->user()?->name ?? 'Admin', ENT_QUOTES, 'UTF-8'); ?></h5>
                                                        <small class="text-muted" id="header-user-role">Admin</small>
                                                    </div>
                                                </div>
                                                <div class="dropdown-divider m-0"></div>
                                                <a class="dropdown-item" href="profilsadmin.php">
                                                    <i class="dropdown-icon fe fe-user"></i> Profil
                                                </a>
                                                <a class="dropdown-item" href="securiteadmin.php">
             ...
             <div class="side-header">
                    ...
                    <div class="main-sidemenu">
                        ...
                        <ul class="side-menu">
                            ...
                            <li class="slide">
                                <a class="sidenav-menu-item" data-bs-toggle="slide" href="projets.php">
                            ...
                            <li class="slide">
                                <a class="sidenav-menu-item" data-bs-toggle="slide" href="utilisateurs.php"><i
                                        class="side-menu__icon fa fa-users"></i><span
                                        class="side-menu__label">Utilisateurs</span>
                                </a>
                            </li>
                             <li class="slide">
                                <a class="sidenav-menu-item" href="secteurs.php"><i
                                        class="side-menu__icon fa fa-tags"></i><span
                                        class="side-menu__label">Secteurs</span>
                                </a>
                            </li>
                             <li class="slide">
                                <a class="sidenav-menu-item" href="document_rules.php"><i
                                        class="side-menu__icon ion-filing"></i><span
                                        class="side-menu__label">Documents exigés</span>
                                </a>
                            </li>
                             <li class="slide">
                                <a class="sidenav-menu-item" href="registration_documents.php"><i
                                        class="side-menu__icon ion-document-text"></i><span
                                        class="side-menu__label">Docs inscription</span>
                                </a>
                            </li>
                            ...
                            <li class="slide">
                                <a class="sidenav-menu-item" href="messagesadmin.php"><i
                            ...
                            <li class="sub-category">
                                <h3>FINANCE & LITIGES</h3>
                            </li>
                
                            <li class="slide">
                                <a class="sidenav-menu-item" href="financementadmin.php"><i
                                        class="side-menu__icon fa fa-line-chart"></i><span
                                        class="side-menu__label">Financement</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="sidenav-menu-item" href="remboursementadmin.php"><i
                                        class="side-menu__icon fa fa-area-chart"></i><span
                                        class="side-menu__label">Remboursement</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="sidenav-menu-item" href="echancesadmin.php"><i
                            ...
                            <li class="slide">
                                <a class="sidenav-menu-item" href="notificationsadmin.php"><i
                                        class="side-menu__icon fa fa-bell"></i><span
                                        class="side-menu__label">Notifications</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="sidenav-menu-item" href="profilsadmin.php"><i
                                        class="side-menu__icon  ion-person"></i><span
                                        class="side-menu__label">Profils</span>
                                </a>
                            </li>
                            <li class="slide">
                                <a class="sidenav-menu-item" href="securiteadmin.php"><i
                             ...
                             <li class="slide">
                                <a class="sidenav-menu-item" href="audit_logsadmin.php"><i
                                        class="side-menu__icon fa fa-history"></i><span
                                        class="side-menu__label">Audit logs</span>
                                </a>
                            </li>
                             <li class="slide">
                                <a class="sidenav-menu-item" href="parametresadmin.php"><i
                                        class="side-menu__icon fa fa-cog"></i><span
                                        class="side-menu__label">Paramètres</span>
                                </a>
                            </li>
