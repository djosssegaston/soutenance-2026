		...
		<div class="container">
			<div class="row align-items-center flex-wrap-reverse gy-4">
				...
				<div class="col-xl-6 col-lg-6 col-md-12">
					<div class="why-choose-us__three-image"> <img src="../asset/images/demo.png" alt="">
						<a href="javascript:void(0)" class="video-btn video-popup video-pulse"> <i class="fas fa-play"></i> </a>
					</div>
				</div>
			</div>
		</div>
